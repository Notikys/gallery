...
//constant
        ...
        define('title', '<title>Gallery</title>');
            ...
            $image7 = '<img src="https://source.unsplash.com/random/240x160"></a>';

            $image8 = '<img src="https://source.unsplash.com/random/240x160"></a>';

            $image9 = '<img src="https://source.unsplash.com/random/240x160"></a>';
